...
public class Nokia230 extends Nokia {
    public  String color;
    public  String material;
    public  String imei = System.currentTimeMillis() + "";
    private int batteryLifeNokia230; // The battery life is put in hours
    ...
    public Nokia230(String color, String material) {
        this.color = color;
        this.material = material;
        this.batteryLifeNokia230 = 15;
    ...
    void sendMessage(String phoneNumber, String messageContent) {
        if (batteryLifeNokia230 > 1) {
            try {
                ...
                batteryLifeNokia230 = batteryLifeNokia230 - 1;
    ...
    void call(String phoneNumber) {
        if (batteryLifeNokia230 > 2) {
            System.out.println("Calling " + phoneNumber);
            historyOfCalls.add(phoneNumber);
            batteryLifeNokia230 = batteryLifeNokia230 - 2;
        }
        else {
            System.out.println("The phone is off. You can't make the call.");
        }

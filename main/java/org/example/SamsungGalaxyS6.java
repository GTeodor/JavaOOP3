...
public class SamsungGalaxyS6 extends Samsung{
    ...
    private int batteryLifeGalaxyS6; // The battery life is put in hours
    ...
    void sendMessage(String phoneNumber, String messageContent) {
       if (batteryLifeGalaxyS6 > 1) {
           try {
               ...
               batteryLifeGalaxyS6 = batteryLifeGalaxyS6 - 1;
    ...
    void call(String phoneNumber) {
        if (batteryLifeGalaxyS6 > 2) {
            System.out.println("Calling " + phoneNumber);
            historyOfCalls.add(phoneNumber);
            batteryLifeGalaxyS6 = batteryLifeGalaxyS6 - 2;
        }
        else {
            System.out.println("The phone is off. You can't make the call.");
        }
